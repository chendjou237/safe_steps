...
class AppTheme extends ThemeExtension<AppTheme> {
  const AppTheme({
    ...
    this.tertiaryColor = Palette.secondary,
    this.neutralColor = Palette.tertiary,
  });
  ...
  ThemeData _base(final ColorScheme colorScheme) {
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor: isLight ? tertiaryColor : colorScheme.background,
      textTheme: textTheme,
